...
public class RTCGLVideoView extends GLSurfaceView{
    ...
    public RTCGLVideoView(Context context) {
        super(context);
        Log.i(TAG, "ctor");
        Log.d("AminLog","in RTCGLVideoView creating RTCGLView with just context");
        init(null);
    }
    ...
    public RTCGLVideoView(Context c, AttributeSet attr) {
        ...
        Log.d("AminLog","in RTCGLVideoView creating GTCGLView tithe context and attr");
    ...
    public VideoRenderer.Callbacks obtainVideoRenderer(RendererSurface rendererSurface){
        ...
        Log.d("AminLog","I am Amin, going to get renderer");
    ...
    private VideoRenderer.Callbacks initRenderer(boolean mirror, int[] viewCoordinates) {
    	Log.d("AminLog","Going to initRenderer with coordinates: x:" + viewCoordinates[0] +
    	" y:" + viewCoordinates[1] +
    	" height:" + viewCoordinates[2] +
    	" width:" + viewCoordinates[3]);
    ...
    Log.d("AminLog","in RTCGLVideoView at main init");
        VideoRendererGui.setView(this, null);
        if (typedArray != null) {
        	Log.d("AminLog","in RTCGLVideoView and typed array not null");
    ...
    private void setValuefromResources(TypedArray typedArray){
        ...
        Log.d("AminLog","in RTCGLVideoView at Set value from resources");
